...
export const PREDEFINED_MATERIALS: MaterialCategory[] = [
                    ...
                    data: [
                      {
                                    ...
                                    productionMethod: 'Katmanli Uretim (SLM/DMLS)',
                                    ...
                                    density: { value: '2.68 g/cm3', standard: '' },
                                    shearModule: { value: '26 GPa', standard: '' },
                                    thermalExp: { value: '23 um/m-K', standard: '' },
                      ...
                      },
                      {
                                    ...
                                    poisson: { value: '0.33', standard: '' },
                                    density: { value: '2.65 g/cm3', standard: '' },
                                    shearModule: { value: '26 GPa', standard: '' },
                                    thermalExp: { value: '21 um/m-K', standard: '' },
                    ...
                    data: [
                      {
                                    ...
                                    productionMethod: 'Kaliba Dokum (Permanent Mold)',
                                    heatTreatment: 'T6',
                                    ...
                                    thermalExp: { value: '21.5 um/m-K', standard: '' },
                    ...
                    data: [
                      {
                                    ...
                                    poisson: { value: '0.33', standard: '' },
                                    density: { value: '2.81 g/cm3', standard: '' },
                                    shearModule: { value: '26.9 GPa', standard: '' },
                                    thermalExp: { value: '23.4 um/m-K', standard: '' },
  ...
  {
        name: 'Paslanmaz Celikler',
        materials: [
          {
                    name: '316L',
                    alternateNames: ['1.4404', 'UNS S31603', 'CF3M (Dokum)'],
                    data: [
                      {
                                    id: '316l-wrought',
                                    materialName: '316L (Dovme/Haddelenmis)',
                                    productionMethod: 'Dovme / Haddeleme',
                                    heatTreatment: 'Tavlanmis',
                                    ...
                                    density: { value: '8.0 g/cm3', standard: '' },
                                    shearModule: { value: '77 GPa', standard: '' },
                                    thermalExp: { value: '16 um/m-K', standard: '' },
                      ...
                      },
                      {
                                    ...
                                    productionMethod: 'Hassas Dokum (Investment Casting)',
                                    heatTreatment: 'Cozeltiye Alma',
                                    yieldStrength: { value: '205 MPa', standard: 'ASTM A351' },
                                    uts: { value: '485 MPa', standard: 'ASTM A351' },
                                    eModule: { value: '190 GPa', standard: '' },
                                    poisson: { value: '0.30', standard: '' },
                                    density: { value: '7.75 g/cm3', standard: '' },
                                    shearModule: { value: '75 GPa', standard: '' },
                                    thermalExp: { value: '15.5 um/m-K', standard: '' },
                    ...
                    data: [
                      {
                                    ...
                                    productionMethod: 'Dovme',
                                    heatTreatment: 'H900 (Yaslandirilmis)',
                                    ...
                                    density: { value: '7.8 g/cm3', standard: '' },
                                    shearModule: { value: '77 GPa', standard: '' },
                                    thermalExp: { value: '10.8 um/m-K', standard: '' },
                    ...
                    data: [
                      {
                                    ...
                                    productionMethod: 'Kum Dokum (Marine)',
                                    heatTreatment: 'Isil Islem Yok',
                                    ...
                                    density: { value: '7.6 g/cm3', standard: '' },
                                    shearModule: { value: '44 GPa', standard: '' },
                                    thermalExp: { value: '16.2 um/m-K', standard: '' },
  ...
  },
  {
        ...
        materials: [
                    ...
                    data: [
                      {
                                    ...
                                    productionMethod: 'Enjeksiyon / Ekstruzyon',
                                    heatTreatment: 'Isil Islem Yok',
                                    ...
                                    density: { value: '1.42 g/cm3', standard: '' },
                                    shearModule: { value: '1.1 GPa', standard: '' },
                                    thermalExp: { value: '110 um/m-K', standard: '' },
          ...
          {
                    name: 'HDPE',
                    alternateNames: ['Yuksek Yogunluklu Polietilen', 'PE-HD'],
                    data: [
                      {
                                    id: 'hdpe-100',
                                    materialName: 'HDPE',
                                    productionMethod: 'Ekstruzyon',
                                    heatTreatment: 'Isil Islem Yok',
                                    ...
                                    density: { value: '0.95 g/cm3', standard: '' },
                                    shearModule: { value: '0.4 GPa', standard: '' },
                                    thermalExp: { value: '200 um/m-K', standard: '' },
